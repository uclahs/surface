...
### Callout with Santa Barbara Sand background

<Canvas of={CalloutStories.SantaBarbaraSand} />

### Callout with Venice Canal background

<Canvas of={CalloutStories.VeniceCanal} />
