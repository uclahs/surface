  ...
  attach(context) {
    (function () {
      function AccordionTabs(el, options) {
        ...
        this.accordionTriggers = this.el.getElementsByClassName(
      ...
      AccordionTabs.prototype._init = function () {
        ...
        this.keys = { prev: 37, next: 39, space: 32, enter: 13 };
        ...
        const resizeTabs = this._debounce(function () {
      ...
      AccordionTabs.prototype._clickEvent = function (e) {
        ...
        let closestTrigger = this._getClosest(e.target, '.js-tabs-trigger');
        let closestTab = 0;
